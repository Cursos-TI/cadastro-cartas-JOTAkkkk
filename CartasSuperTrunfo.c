...
int main() {
  ...
  //area para escolha da comparação entre as cartas
  printf("Escolha a comparação entre as cartas:\n");
  printf("1 - População\n");
  printf("2 - Área\n");
  printf("3 - PIB\n");
  ...
  default:
    printf("Opção inválida. Por favor, escolha 1 para jogar ou 2 para sair.\n");
    break;
  }
